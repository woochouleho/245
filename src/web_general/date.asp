...
<div class="intro_main ">
	<p class="intro_title"><% multilang(LANG_SYSTEM_DATE_AND_TIME_MODIFICATION); %></p>
	<p class="intro_content"> <% multilang(LANG_SET_THE_SYSTEM_DATE_AND_TIME); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
	      <th width=30%><font size=2><b><% multilang(LANG_DATE); %>:</b></td>
	      <td width=70%>
	  ...
	  <tr>
	      <th width=30%><font size=2><b><% multilang(LANG_TIME); %>:</b></td>
	      <td width=70%>
	  ...
	  <tr>
	      <th width=30%><font size=2><b><% multilang(LANG_TIME_ZONE); %>:</b></td>
	      <td width=70%>
	      	<select name="sys_tz">
...
<div class="btn_ctl">
	...
	<input class="link_bg" type="submit" value="<% multilang(LANG_SUBMIT); %>" name="set" onClick="return on_submit()">&nbsp;&nbsp;
	<input class="link_bg" type="button" value="<% multilang(LANG_CANCEL); %>" name="close" onClick="javascript: window.close();">
