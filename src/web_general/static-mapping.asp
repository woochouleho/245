<%SendWebHeadStr(); %>
<title><% multilang(LANG_STATIC_MAPPING); %></title>
...
function addClick(obj)
{
	...
	for(var i=0;i<mutli_localFromPort.length;i++)
	{
		...
		if (isAttackXSS(mutli_comment[i].value)) {
			alert("ERROR: Please check the value again");
			mutli_comment[i].focus();
			return false;
		}
...
function updateState()
{
	...
	if (document.formPortFwAdd.portFwcap[1].checked)
	{
		for(var i=0;i<mutli_localFromPort.length;i++)
		{
			...
			mutli_comment[i].value = "static_mapping";
			...
			mutli_interface[i].selectedIndex = 1;
		}
...
<div class="intro_main ">
	<p class="intro_title"><% multilang(LANG_STATIC_MAPPING); %></p>
</div>

<form action=/boaform/formStaticMapping method=POST name="formPortFwAdd">
<div class="data_common data_common_notitle" style="display:none;">
	<table>
		<tr>
			<th width="30%"><% multilang(LANG_STATIC_MAPPING); %>:</th>
			<td width="40%">
...
<table style ="table-layout:fixed; overflow:hidden;">
	...
	<tr>  <!-- 0 -->
		<td style="display:none"><input type="text" name="comment[]" size="30" maxlength="15"> </td>
...
<div class="btn_ctl">
	...
	<input type="hidden" value="/static-mapping.asp" name="submit-url">
	<% showPFWAdvForm(); %>
</div>
...
<form action=/boaform/formStaticMapping method=POST name="formPortFwDel">
<div class="column">
	<div class="column_title">
		<div class="column_title_left"></div>
		<p> <% multilang(LANG_CURRENT_STATIC_MAPPING_TABLE); %></p>
		<div class="column_title_right"></div>
	</div>
	<div class="data_common data_vertical">
	<table>
		<% portStaticMappingList(); %>
	</table>
	</div>
</div>
<div class="btn_ctl">
