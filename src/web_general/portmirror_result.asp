	...
	if (xhr2.upload) {
		...
		xhr2.onload = function() {
			if (xhr2.readyState == xhr2.DONE) {
				if (xhr2.status == 200)
					document.getElementById("portmirrorInfo").innerHTML = xhr2.responseText;
			}
		};		
		xhr2.send();
	}
...
function cleanrTimer(){
	...
	window.location.replace('/portmirror.asp');
}
...
<br>
<form id="result" action="/boaform/formPortMirrorResult" method="POST" name="result">
<div align="left">
	<table id="portmirrorInfo">
	</table>
	<br>
</div>
</form>
