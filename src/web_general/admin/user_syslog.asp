...
function loadFileContent() {
	...
	fetch(fullPath)
		...
		.then(content => {
				...
				lines = lines.filter(line => !line.includes("Trap#17 Key Exchange"));
...
{
	parent.document.getElementById("/admin/user_syslog.asp").click(); 
}
</script>
</head>
...
<div class="column">
	...
	<div class="data_common">
		<table>
			...
			<tr>
				<td colspan="2">
				<textarea id="fileContent" style='color:#ffffff; background-color:black; width:100%; height:300px; resize: none; min-height: 400px;' readonly></textarea>
				</td>
			</tr>
		</table>
...
<div class="btn_ctl">
	...
	<input type="hidden" value="/admin/user_syslog.asp" name="submit-url">
