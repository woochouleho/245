...
function applyclick()
{
	...
	/*auth*/
	if( document.form3gconf.auth.selectedIndex!=5 )
	{
		/*username*/
	  ...
	  <tr>
	      ...
	      <td width="70%">
			<select size=1 name="auth" onChange="authchange()">
				...
				<option <% fm3g_checkWrite("fm3g-auth-mschap"); %> value=3>MSCHAP</option>
				<option <% fm3g_checkWrite("fm3g-auth-mschapv2"); %> value=4>MSCHAPV2</option>
				<option <% fm3g_checkWrite("fm3g-auth-none"); %> value=5><% multilang(LANG_NONE); %></option>
			</select>
	      </td>
	  </tr>
	  <tr>
