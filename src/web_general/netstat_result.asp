		...
		xhr2.onload = function() {
			if (xhr2.readyState == xhr2.DONE) {
				if (xhr2.status == 200) {
					...
					document.getElementById("netstatInfo").innerHTML = xhr2.responseText;
				}
			}
		};		
		xhr2.send();
...
function cleanrTimer(){
	...
	window.location.replace('/admin/netstat.asp');
}
...
<br>
<form id="result" action="/boaform/admin/formNetstatResult" method="POST" name="result">
<div align="left">
	<table id="netstatInfo">
	</table>
	<br>
</div>
</form>
