		...
		xhr2.onload = function() {
			if (xhr2.readyState == xhr2.DONE) {
				if (xhr2.status == 200) {
					...
					document.getElementById("grouptableInfo").innerHTML = xhr2.responseText;
				}
			}
		};		
		xhr2.send();
...
function cleanrTimer(){
	...
	window.location.replace('/grouptable.asp');
}
...
<br>
<form id="result" action="/boaform/formGroupTableResult" method="POST" name="result">
<div align="left">
	<table id="grouptableInfo">
	</table>
	<br>
</div>
</form>
