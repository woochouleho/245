...
<div class="intro_main ">
	<p class="intro_title"><% multilang(LANG_DEVICE); %> <% multilang(LANG_IP_RANGE); %><% multilang(LANG_TABLE_2); %></p>
	<p class="intro_content"> <% multilang(LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_IP_ADDRESS_RANGE_BASED_ON_DEVICE_TYPE); %></p>
</div>
...
<form action=/boaform/formIpRange method=POST name="ipRange">
	...
	<div class="data_common data_common_notitle">
		<table>
			<tr>
				<th width=30%><% multilang(LANG_DEVICE); %><% multilang(LANG_NAME); %>:&nbsp;&nbsp;</th>
			...
			<tr>
				<th width=30%><% multilang(LANG_DEVICE_TYPE); %>:&nbsp;&nbsp;</th>
		...
		<table id="option241" style="display:">
			<tr>
				<th width=30%><% multilang(LANG_RESERVED_OPTION); %>:&nbsp;&nbsp;</th>
...
<div class="btn_ctl">
	...
	<input class="link_bg" type="submit" value="<% multilang(LANG_DELETE); %>" name="del" onClick="return delClick()">&nbsp;&nbsp;
	<input class="link_bg" type="submit" value="<% multilang(LANG_MODIFY); %>" name="mod" onClick="return addClick(this)">&nbsp;&nbsp
...
<div class="column">
	<div class="column_title">
		<div class="column_title_left"></div>
			<p><% multilang(LANG_DEVICE); %> <% multilang(LANG_IP_RANGE); %><% multilang(LANG_TABLE_2); %></p>
