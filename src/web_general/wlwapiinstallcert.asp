...
<div class="intro_main ">
	<p class="intro_title">WAPI <% multilang(LANG_CERTIFICATION_INSTALLATION); %></p>
	<p class="intro_content"> <% multilang(LANG_THIS_PAGE_ALLOWS_YOU_TO_INSTALL_ASU_AND_USER_CERTIFICATION_FOR_YOUR_DEVICE_PLEASE_NOTE_CERTIFICATION_TYPE_X_509_IS_SUPPORTED_AT_PRESENT); %></p>
</div>
...
<div class="btn_ctl">
    <input class="link_bg" onclick=sendClicked(this.form) type=button value="<% multilang(LANG_UPLOAD); %>" name="send">&nbsp;&nbsp;    
