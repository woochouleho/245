...
<div class="intro_main ">
	<p class="intro_title">WDS <% multilang(LANG_SETTINGS); %></p>
	<p class="intro_content"> <% multilang(LANG_WIRELESS_DISTRIBUTION_SYSTEM_USES_WIRELESS_MEDIA_TO_COMMUNICATE_WITH_OTHER_APS_LIKE_THE_ETHERNET_DOES_TO_DO_THIS_YOU_MUST_SET_THESE_APS_IN_THE_SAME_CHANNEL_AND_SET_MAC_ADDRESS_OF_OTHER_APS_WHICH_YOU_WANT_TO_COMMUNICATE_WITH_IN_THE_TABLE_AND_THEN_ENABLE_THE_WDS); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		...
		<tr>
		   ...
		   <td><input class="inner_btn" type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="wdsSet" onClick="return on_submit(this)">&nbsp;&nbsp;</td>
		</tr>
	</table>
</div>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang(LANG_ADD); %>" name="addWdsMac" onClick="return addClick(this)">&nbsp;&nbsp;
	<input class="link_bg" type="reset" value="<% multilang(LANG_RESET); %>" name="reset">&nbsp;&nbsp;&nbsp;&nbsp;
	<input class="link_bg" type="button" value="<% multilang(LANG_SET_SECURITY); %>" name="showWep" onClick="showWepClick('/wlwdsenp.asp')">&nbsp;&nbsp;
	<input class="link_bg" type="button" value="<% multilang(LANG_SHOW_STATISTICS); %>" name="showAp" onClick="showApClick('/wlwdstbl.asp')">&nbsp;&nbsp;
...
<div class="column">
	<div class="column_title">
		<div class="column_title_left"></div>
			<p><% multilang(LANG_CURRENT_WDS_AP_LIST); %></p>
...
<div class="btn_ctl">  
	<input class="link_bg" type="submit" value="<% multilang(LANG_DELETE_SELECTED); %>" name="deleteSelWdsMac" onClick="return deleteClick(this)">&nbsp;&nbsp;
	<input class="link_bg" type="submit" value="<% multilang(LANG_DELETE_ALL); %>" name="deleteAllWdsMac" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
	<input class="link_bg" type="reset" value="<% multilang(LANG_RESET); %>" name="reset">
	<input type="hidden" value="/admin/wlwds.asp" name="submit-url">
	<input type="hidden" name="wlan_idx" value=<% checkWrite("wlan_idx"); %>>
	<input type="hidden" name="postSecurityFlag" value="">
