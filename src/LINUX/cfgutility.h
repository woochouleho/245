...
extern int setUpnpCapability(unsigned char enabled,unsigned int ifIndex);
...
extern int addRipInterface(MIB_CE_RIP_Tp pEntry);
extern int delRipInterface(int index);
extern int addOspfRule(MIB_CE_OSPF_Tp pEntry);
extern int delOspfRule(int index);
extern int addIsisRule(MIB_CE_ISIS_Tp pEntry);
extern int delIsisRule(int index);
extern int addBgpNetworkRule(MIB_CE_BGP_NETWORK_Tp pEntry);
extern int delBgpNetworkRule(int index);
extern int addBgpNeighbourRule(MIB_CE_BGP_NEIGHBOUR_Tp pEntry);
extern int delBgpNeighbourRule(int index);
extern void showIgpProtocol();
extern void showIgpRip();
extern void showIgpOspf();
extern void showIgpBgp();
extern void showIgpIsis();
#endif
#ifdef ROUTING
