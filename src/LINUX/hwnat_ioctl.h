...
enum HWNAT_IOCTL_ITF_CMD_TYPE{
	Get_ShapingRate_CMD,
	Get_ShapingBurstSize_CMD,
	Set_ShapingRate_CMD,
	Set_ShapingBurstSize_CMD,
};

struct hwnat_ioctl_itf_cmd{
	unsigned type;
	char ifname[IFNAMSIZ];
	union{
		int ShapingRate;
		unsigned int ShapingBurstSize;
	} u;
};
